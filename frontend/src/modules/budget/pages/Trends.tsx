        ...
        <>
          ...
          {anomalies.length > 0 && (
            <div className="space-y-2">
              <div className="text-xs font-medium text-white uppercase tracking-wider">Spending Alerts</div>
              {anomalies.map(a => (
          ...
          {monthlyData.length > 0 && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h2 className="text-xs font-medium text-white uppercase tracking-wider mb-5">Income vs Spend</h2>
          ...
          {stackedAreaData.length > 1 && topCategories.length > 0 && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h2 className="text-xs font-medium text-white uppercase tracking-wider mb-5">
          ...
          {categoryData.length > 0 && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-xs font-medium text-white uppercase tracking-wider">Category Spotlight</h2>
                <select
                  value={spotlightCat}
          ...
          {categoryData.length > 0 && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h2 className="text-xs font-medium text-white uppercase tracking-wider mb-5">By Category</h2>
          ...
          {accountData.length > 0 && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h2 className="text-xs font-medium text-white uppercase tracking-wider mb-4">By Account</h2>
